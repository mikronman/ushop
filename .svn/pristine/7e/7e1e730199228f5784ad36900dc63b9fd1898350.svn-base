...
<?php $this->beginBody() ?>
    ...
    <header class="cd-main-header">
		<a href="#0" class="cd-logo"><!--<img src="img/logo.png" alt="Logo">-->
		...
		<nav class="cd-side-nav">
			<ul>
				...
				<li class="has-children">
					<a href="#0">My Products</a>
					
					<ul>
                        <li><a href="<?= url::to(['site/add_product'])?>">Add a Product</a></li>
						<li><a href="<?= url::to(['site/products'])?>">Manage Products</a></li>
			...
			<ul>
				...
				<li class="action-btn"><a href="#0">Place an Order</a></li>
			</ul>
		</nav>
