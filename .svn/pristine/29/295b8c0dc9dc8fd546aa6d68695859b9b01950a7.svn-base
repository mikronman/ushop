...
<div class="orders-form">
    ...
    <div class="w100 left mb25 pl15 respond-width"><h3>Customer Information</h3></div>
    <?= (isset($create)) ? "" : $form->field($model, 'order_id')->textInput() ?>
    <?= (isset($create)) ? "" : $form->field($model, 'id')->textInput() ?>
    <?= (isset($create)) ? "" : $form->field($model, 'transaction_id')->textInput(); ?>
    ...
    <div class="w66 left pl15 respond-width">
        <?= $form->field($model, 'address')->textInput(['maxlength' => true]) ?>
    </div>
    <div class="w33 left pl15 respond-width">
        <?= $form->field($model, 'address2')->textInput(['maxlength' => true]) ?>
    </div>
    <div class="w25 left pl15 respond-width">
    ...
    <div class="w100 left mt25 ">
        <div class="w100 left mb25 pl15 respond-width"><h3>Product Information</h3></div>
        <!--
        ...
        <div class="w50 left pl15 respond-width">
            <?php
            $productTypes = \app\models\Products::find()->select('product_name')->orderBy('product_name')->asArray()->all();
            //var_dump($productTypes["0"]["product_name"]);
            ?>
            <?= (isset($create)) ? $form->field($model, 'product_name')->dropDownList(\yii\helpers\ArrayHelper::map(\app\models\Products::find()->asArray()->all(), 'product_name', 'product_name')) : $form->field($model, 'product_name')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="w25 left pl15 respond-width">
        ...
        -->
        <div class="w50 left pl15 respond-width" id="subscriptionBillingContainer">
    ...
    <div class="w100 left mt25">
        <div class="w100 left mb25 pl15 respond-width"><h3>Payment Information</h3></div>
        <div class="w25 left pl15 respond-width">
    ...
    -->
    <div class="w100 left mt15 mb25 pl15 respond-width">
        <div class="form-group">
