...
<div class="campaigns-form">
    ...
    <div class="w100 left bump-bottom">
		...
		<div class="w33 left pa5 respond-width">
			<?= $form->field($model, 'currency')->dropDownList(array('us' => 'United States'))?>
		</div>
		<!--
		<div class="w33 left pa5 respond-width">
			<?= $form->field($model, 'enable_tax')->textInput(['maxlength' => true]) ?>
		</div>
		-->
		<!-- These values should be collected automatically by knowing timestamp and who's logged in
	...
	<div class="w100 left pa5 mt15 mb20 respond-width"><h3>Campaign Products</h3></div>
    <div id="dynamicCampaignProducts"></div>
    
    <div id='TextBoxesGroup'>
        <div id="TextBoxDiv1" class="w100 left r5 pa10 bgc1">
            <?php if(isset($update))
				{
					$model->prod_id = '';
				}
            ...
            <div class="w50 left pa5 respond-width">
				<?= $form->field($model, 'prod_price[]')->textInput(['maxlength' => true])?>
			</div>
            <?php
    ...
    <button type='button' class="btn" value='Add Button' id='addButton'>Add Button</button>
    <button type='button' class="btn" value='Remove Button' id='removeButton'>Remove Button</button>
