...
<div class="orders-search">
    ...
    <?php // echo $form->field($model, 'upsell_id') ?>
    ...
    <?php // echo $form->field($model, 'cc_last_four') ?>
    ...
    <?php // echo $form->field($model, 'sub_aff_id') ?>

    <?php // echo $form->field($model, 'confirm_status') ?>

    <?php // echo $form->field($model, 'rma') ?>

    <?php // echo $form->field($model, 'billing_cycle') ?>

    <?php // echo $form->field($model, 'routing_number') ?>

    <?php // echo $form->field($model, 'order_date') ?>

    <?php // echo $form->field($model, 'next_r_date') ?>

    <?php // echo $form->field($model, 'next_r_product') ?>
